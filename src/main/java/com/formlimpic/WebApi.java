...
public class WebApi {
    ...
    WebApi(ReceiptStore store, PasswordEncoder encoder) {
        this.store = store;
    ...
    record UserProfile(String id, String username, String membershipCode) implements java.io.Serializable {}
    ...
    Object signup(@RequestBody AuthRequest req, HttpSession session) {
        ...
        UserProfile profile = new UserProfile(user.id(), user.username(), user.membershipCode());
